  ...
  return h("div", { class: "fixed inset-0 u-modal-shell bg-black/80 backdrop-blur-md z-[999] flex items-center justify-center p-4", ref: containerRef, onClick: onBackdropClick },
    h("div", { class: "glass-panel p-6 md:p-8 rounded-[2rem] w-full max-w-2xl shadow-2xl relative max-h-[90vh] flex flex-col border border-emerald-500/50" },
      ...
      h("div", { class: "space-y-3 flex-1 u-scroll-area custom-scrollbar pr-1" },
        h("div", null,
          h("label", { class: "block text-[11px] font-bold text-emerald-400 uppercase mb-1" }, h(Icon, { name: "users", class: "mr-1" }), t("ui.paste_list_label")),
          ...
          h("p", { class: "text-[11px] text-slate-500 mt-1" }, t("ui.paste_list_hint"), " ", h("b", null, "Nama|628xxxxxxxxxx"), " ", t("ui.paste_list_hint2"))),
        h("div", null,
          h("label", { class: "block text-[11px] font-bold text-emerald-400 uppercase mb-1" }, h(Icon, { name: "link", class: "mr-1" }), t("ui.group_link_label")),
        ...
        h("div", { class: "u-grid-auto u-grid-auto--form gap-3" },
          h("div", null,
            h("label", { class: "block text-[11px] font-bold text-emerald-400 uppercase mb-1" }, h(Icon, { name: "stopwatch", class: "mr-1" }), t("ui.interval_label")),
          ...
          h("div", { class: "flex flex-col items-end justify-end gap-0.5" },
            ...
            variants.length > 1 ? h("span", { class: "text-[11px] font-bold text-amber-400" }, " • " + t("ui.variant_count_n").replace("{n}", String(variants.length))) : null)),
        h("div", null,
          h("label", { class: "block text-[11px] font-bold text-emerald-400 uppercase mb-1" }, h(Icon, { name: "comment-dots", class: "mr-1" }), t("ui.message_label")),
          ...
          h("p", { class: "text-[11px] text-slate-500 mt-1" }, t("ui.message_hint"), " ", h("b", null, "{nama}"), " ", t("ui.message_hint2"), " ", h("b", null, "{link_grup}"), " ", t("ui.message_hint3"))),
        h("div", { class: "bg-black/40 border border-slate-700 rounded-xl p-3" },
          h("p", { class: "text-[11px] font-bold text-slate-400 mb-1 uppercase" }, h(Icon, { name: "eye", class: "mr-1" }), t("ui.message_preview")),
